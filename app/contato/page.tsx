      ...
      <form className="space-y-5" action="#" method="POST">
        <div>
          ...
          <input
            ...
            name="name"
            required
            className="w-full bg-[#13131a] border border-[#2a2a3a] rounded-lg px-4 py-3 text-gray-200 placeholder:text-gray-600 focus:outline-none focus:border-violet-600 transition-colors text-sm"
        ...
        <div>
          ...
          <select
            id="subject"
            name="subject"
            className="w-full bg-[#13131a] border border-[#2a2a3a] rounded-lg px-4 py-3 text-gray-200 focus:outline-none focus:border-violet-600 transition-colors text-sm"
          >
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={6}
            className="w-full bg-[#13131a] border border-[#2a2a3a] rounded-lg px-4 py-3 text-gray-200 placeholder:text-gray-600 focus:outline-none focus:border-violet-600 transition-colors text-sm resize-none"
